...
<header>
    <div class="logo"><span>Exam</span>Zone</div>
    <nav>
        <a href="#">Home</a>
        <a href="#">Exam</a>
        <a href="#">Events</a>
        ...
        ?>
            ...
            <div class="profile-menu">
                <div class="user-profile">
                    <div class="user-img">
                        <img src="image/userprofile/male1.png" alt="">
                    </div>
                    <div class="user-info">
                        <span class="name"> Mahammad ali </span>
                        <span class="email"> mahammadali2307@gmail.com </span>
                    </div>
                </div>
                <div class="menu-item">
