  ...
  <div class="row ml-15 mt-15">
    ...
    <div class="column-6">
      <div class="card">
        <div class="card-body">
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" height="50" width="45" viewBox="0 0 640 512">
              <!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              <path fill="#1c1c38"
    ...
    <div class="column-6">
      <div class="card">
        <div class="card-body">
          ...
          <div class="content">
            <h1 class="total-DeActiveStd">
              <!-- total-DeActiveStd -->
            </h1>
            <p>De-Active Students</p>
          </div>
        </div>
      </div>
    </div>
